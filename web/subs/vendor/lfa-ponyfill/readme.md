...
Local Font Access API ponyfilled via Google Fonts API. Allows you to use LFA on any environment which supports `fetch` and ESM `import()`.
...
const all = await queryLocalFonts() // >7.6k fonts, 1.9k font families!
