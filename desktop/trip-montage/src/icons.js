/** Lucide-style stroke icons (same visual language as the site). */

function svg(paths) {
  return `<svg viewBox="0 0 24 24" width="16" height="16" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${paths}</svg>`;
}
...
export const icons = {
  ...
  flagEnd: svg(
    '<line x1="20" y1="3" x2="20" y2="21"/><path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/>',
  ),
  x: svg('<line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/>'),
  play: svg('<polygon points="6 3 20 12 6 21 6 3"/>'),
};

export function withIcon(iconHtml, label) {
